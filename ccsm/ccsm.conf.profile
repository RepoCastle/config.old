...
[core]
s0_active_plugins = core;composite;opengl;mousepoll;grid;wall;commands;compiztoolbox;regex;snap;imgpng;vpswitch;resize;copytex;move;place;unitymtgrabhandles;session;animation;expo;workarounds;fade;ezoom;scale;unityshell;
...
s0_outputs = 1366x768+0+132;1440x900+1366+0;
...
s0_run_command_terminal_key = <Super>k
